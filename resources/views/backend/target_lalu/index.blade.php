...
@section('title', 'Target Lalu ')
@section('content-title', 'Target Lalu Cabang '. ucfirst(optional(optional(auth()->user())->getCabang)->cabang))
@section('css')
					...
					$.ajax({
						...
						success:function(data) {
							if (data.code == '200'){
								...
								window.location.replace("{{ action('TargetLaluController@index') }}");
							}
						}
					});
...
<div class="card card-outline card-primary collapsed-card">
	...
	<div class="card-body" style="display: none;">
		@includeIf('backend.target_lalu.create')
	</div>
	<!-- /.card-body -->
</div>
