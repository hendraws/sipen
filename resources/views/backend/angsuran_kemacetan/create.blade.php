...
<form action="{{ action('AngsuranKemacetanController@store') }}" method="POST">
	...
	<div class="form-group row">
		...
		<div class="col-md-10">
			<input type="text" id="tanggal" class="form-control tanggal" name="tanggal"  autocomplete="off" value="{{ $today }}" readonly>
		</div>
	</div>
	<div class="form-group row">
	...
	<div class="form-group row">
		...
		<div class="col-md-10">
			<select class="form-control" name="pasaran" readonly>
