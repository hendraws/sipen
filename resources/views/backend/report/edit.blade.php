...
@section('content-title', 'Edit Report')
@section('css')
...
<div class="card card-primary card-outline">
	<div class="card-body">
		<form action="{{ action('ReportController@update', $data->id) }}" method="POST" id="kantorCabangForm">
			@csrf
			@method('PATCH')
			...
			<div class="modal-footer">
				<a href="{{ action('ReportController@index') }}" class="btn btn-secondary">Kembali</a>
